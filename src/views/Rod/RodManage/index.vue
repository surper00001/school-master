<template>
  ...
  <div class="card-container">
    ...
    <div class="create-container">
      <el-button type="primary" @click="$router.push('/car/addMonthCard')">添加一体杆</el-button>
    ...
    <div class="table">
      <el-table style="width: 100%" :data="list" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="一体杆名称" prop="personName" />
        <el-table-column label="一体杆编号" prop="totalEffectiveDate" />
        <el-table-column label="一体杆IP" prop="phoneNumber" />
        <el-table-column label="安装区域" prop="carNumber" />
        <el-table-column label="一体杆类型" prop="carBrand" />
      
        <el-table-column label="运行状态" prop="cardStatus" :formatter="formatStatus" />
